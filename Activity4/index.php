...
<div class="container-fluid">
    ...
    <form class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
             <div class="checkbox">
               <label class="checkinbox-inline"><input type="checkbox">PHP</label>
               <label class="checkinbox-inline"><input type="checkbox">BOOTSTRAP</label>
               <label class="checkinbox-inline"><input type="checkbox">JAVA</label>
             </div>
      </div>
      </div>
