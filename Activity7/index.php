...
<body data-spy="scroll" data-target=".navbar">
    ...
    <section id="work" class="container">
        ...
        <div class="text-center">
            <img src="image/port1.png" class="img-thumbnail"></img>
            <img src="image/port2.png" class="img-thumbnail"></img>
            <img src="image/port3.png" class="img-thumbnail"></img>
            <img src="image/port4.png" class="img-thumbnail"></img>
            <img src="image/port5.png" class="img-thumbnail"></img>
            <img src="image/port6.png" class="img-thumbnail"></img>
        </div>
    </section>
    <section id="about" class="container">
        <h2 class="text-center">My Skills</h2>
        <div class="col-text">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, 
